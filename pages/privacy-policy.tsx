  ...
  return (
    <MainLayout>
      <Container maxWidth="md">
        ...
        <p>
          It is PhotoNow.io's policy to respect your privacy regarding any information we may
          collect while operating our website. This Privacy Policy applies to{" "}
          <a href="https://photonow.io">https://photonow.io</a> (hereinafter, "us", "we", or
          "https://photonow.io"). We respect your privacy and are committed to protecting personally
          identifiable information you may provide us through the Website. We have adopted this
        ...
        <p>
          ...
          forth the general rules and policies governing your use of our Website. Depending on your
          activities when visiting our Website, you may be required to agree to additional terms and
          conditions.
        </p>
        <h2>Website Visitors</h2>
        <p>
          Like most website operators, PhotoNow.io collects non-personally-identifying information
          ...
          PhotoNow.io's purpose in collecting non-personally identifying information is to better
          understand how PhotoNow.io's visitors use its website. From time to time, PhotoNow.io may
        ...
        <p>
          PhotoNow.io also collects potentially personally-identifying information like Internet
          Protocol (IP) addresses for logged in users and for users leaving comments on
          https://photonow.io blog posts. PhotoNow.io only discloses logged in user and commenter IP
          addresses under the same circumstances that it uses and discloses personally-identifying
          information as described below.
        </p>
        <h2>Gathering of Personally-Identifying Information</h2>
        <p>
          Certain visitors to PhotoNow.io's websites choose to interact with PhotoNow.io in ways
          that require PhotoNow.io to gather personally-identifying information. The amount and type
          of information that PhotoNow.io gathers depends on the nature of the interaction. For
          example, we ask visitors who sign up for a blog at https://photonow.io to provide a
        ...
        <p>
          ...
          covers the use of cookies by PhotoNow.io and does not cover the use of cookies by any
          advertisers.
        </p>
        ...
        <p>
          PhotoNow.io may collect statistics about the behavior of visitors to its website.
          PhotoNow.io may display this information publicly or provide it to others. However,
          PhotoNow.io does not disclose your personally-identifying information.
        </p>
        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, PhotoNow.io uses "Cookies", similar
        ...
        <p>
          ...
          PhotoNow.io uses cookies to help PhotoNow.io identify and track visitors, their usage of
          https://photonow.io, and their website access preferences. PhotoNow.io visitors who do not
          wish to have cookies placed on their computers should set their browsers to refuse cookies
          before using PhotoNow.io's websites, with the drawback that certain features of
          PhotoNow.io's websites may not function properly without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie settings, you hereby
          acknowledge and agree to PhotoNow.io's use of cookies.
        </p>
        <h2>E-commerce</h2>
        <p>
          Those who engage in transactions with PhotoNow.io – by purchasing PhotoNow.io's services
          or products, are asked to provide additional information, including as necessary the
          personal and financial information required to process those transactions. In each case,
          PhotoNow.io collects such information only insofar as is necessary or appropriate to
          fulfill the purpose of the visitor's interaction with PhotoNow.io. PhotoNow.io does not
        ...
        <p>
          Although most changes are likely to be minor, PhotoNow.io may change its Privacy Policy
          from time to time, and in PhotoNow.io's sole discretion. PhotoNow.io encourages visitors
        ...
        <p>
          ...
          <a href="mailto:sreeni@photonow.io">email</a> or <a href="tel:07955555555">phone</a>.
        </p>
      </Container>
    </MainLayout>
  )
